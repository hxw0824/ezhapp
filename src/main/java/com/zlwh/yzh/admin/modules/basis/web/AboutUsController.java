 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/basis/aboutus")
public class AboutUsController extends BaseController {
	...
	@RequiresPermissions("basis:aboutus:edit")
	...
	public String save(Article article, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/basis/aboutus/form?repage";
	}
