 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/basis/message")
public class MessageController extends BaseController {
	...
	@RequiresPermissions("basis:message:view")
	...
	public String list(Message message, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/basis/messageList";
	}
	...
	public String form(Message message, Model model) {
		...
		return "modules/basis/messageForm";
	}

	@RequiresPermissions("basis:message:edit")
	...
	public String save(Message message, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/basis/message/?repage";
	}
