		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="type" class="input-medium">
					...
					<form:options items="${fns:getDictList('sys_office_type')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> 添加学校请务必选择幼儿园</span>
			</div>
		</div>
		<div class="control-group hidden">
