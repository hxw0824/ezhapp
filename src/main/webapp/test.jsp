...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="http://192.168.9.57:8080/yzh_fa/v1.0/alipay/pay" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>商户号 ：</dt>
					<dd>
						<input id="WID_trade_user" name="WID_trade_user" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
					...
					<dt>用户token：</dt>
					<dd>
						<input id="userToken" name="userToken" />
					</dd>
		 ...
		 <form name=tradequery action="http://192.168.9.57:8080/yzh_fa/v1.0/alipay/query" method=post
		...
		<form name=traderefund action="http://192.168.9.57:8080/yzh_fa/v1.0/alipay/refund" method=post
			target="_blank">
		...
		<form name=traderefundquery
			action="http://192.168.9.57:8080/yzh_fa/v1.0/alipay/refundQuery" method=post
			target="_blank">
		...
		<form name=tradeclose action="http://192.168.9.57:8080/yzh_fa/v1.0/alipay/close" method=post
			target="_blank">
